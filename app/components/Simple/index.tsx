    ...
    return (
        <div className="simple-bg relative">
            ...
            <div className="mx-auto max-w-5xl py-24 px-6">
                <h3 className="text-center text-offwhite text-3xl lg:text-5xl font-semibold mb-6">With CryptoMac You learn A simple, secure way to buy <br /> and sell cryptocurrency</h3>
                <p className="text-center text-bluish text-lg font-normal mb-8">Crypto exchanges are the safest and most legal way to obtain cryptocurrency. <br /> Crypto exchanges let users buy and sell cryptocurrencies online or using a mobile app, making it easy to access the crypto markets from anywhere.</p>
