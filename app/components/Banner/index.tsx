                ...
                <div className='height-work'>
                    <div className='grid grid-cols-1 lg:grid-cols-12 my-16'>
                        ...
                        <div className='col-span-7'>
                            ...
                            <p className='text-white md:text-lg font-normal mb-10 md:text-start text-center'>How to Trade Cryptocurrency with CryptoMac <br /> The cryptocurrency market has exploded in popularity in recent years. <br /> it is important to know how to trade cryptocurrencies – so, we have compiled a list of everything you need to know to get started</p>
